      ...
      <section className="py-[3rem]">
        <div className="wrapper">
          <p className="description text-center">
            At EVOCRUX , we offer a comprehensive suite of services designed to
            meet the diverse needs of modern businesses. Whether you're looking
            to develop cutting-edge software, enhance your data analytics
            capabilities, or secure your digital assets, we have the expertise
